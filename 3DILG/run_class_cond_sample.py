...
def get_args():
    ...
    # Model parameters
    parser.add_argument('--model', default='class_encoder_21_512_1024_24_K1024', type=str, metavar='MODEL')
...
def main(args):
    ...
    for i in tqdm(range(100)):
        with torch.no_grad():
            ...
            m.export(f'test_12layer/sample_{i}.obj')
            # m.export(f'Front_{id}/sample_{i}.obj')
