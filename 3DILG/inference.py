...
parser.add_argument('--pth', default='output/vqvae_512_1024_2048_new/checkpoint-5999.pth', type=str)
...
from FRONT import _3DFRONT, FRONT_category, Living_category
...
def main():
    ...
    with torch.no_grad():
        ...
        metric_loggers = []
        for category, _ in Living_category.items():
            if  not category == 'dining_chair':
                continue
            ...
            dataset_test = _3DFRONT(args.data_path, categories=[category], split='train', transform=None, sampling=False, return_surface=True,
