    ...
    def post_process(self, s):
        ...
        for k, v in s.items():
            if k == "room_layout" or k == "class_labels":
                ...
                #Note: Here is for descale from the output.
...
class OrderedDataset(DatasetDecoratorBase): #Note: final encoded function
...
def dataset_encoding_factory(
    ...
    # elif "shape" in name:
    #     shape_orderer_dataset = BoxOrderedDataset(
    #         dataset,
    #         box_ordering
    #     )
    #     room_layout = RoomLayoutEncoder(shape_orderer_dataset)
    #     class_labels = ClassLabelsEncoder(shape_orderer_dataset)
    #     translations = TranslationEncoder(shape_orderer_dataset)
    #     sizes = SizeEncoder(shape_orderer_dataset)
    #     angles = AngleEncoder(shape_orderer_dataset)
    #     shape = ShapenEncoder(shape_orderer_dataset)
    #
