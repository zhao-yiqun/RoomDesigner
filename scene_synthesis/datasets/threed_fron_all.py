...
class ThreedFrontShape(BaseDataset):
...
class CachedThreedFrontShape(ThreedFrontShape):
    ...
    def get_room_params(self, i):
        ...
        for jid in shape_name:
            ...
            # surface20w_npy = os.path.join("/public/home/zhaoyq/3D-FUTURE-model-points", f"{jid}_points.npy")
            surface20w = np.load(surface20w_npy)
